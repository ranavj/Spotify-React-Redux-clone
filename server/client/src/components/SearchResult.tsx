...
export function SeacrchResult() {
    ...
    return(
        <>
            ...
            {seacrchResult && seacrchResult?.tracks?.items?.slice(0,10).map((item:any) => <li className="col-span-1 truncate li hover:bg-neutral-700">
            ...
            <section className="max-w-prose	 mx-auto grid grid-cols-2 text-white">
                ...
                <div className="col-start-1 col-end-3">
                <ul className="grid grid-cols-2 gap-4 mb-3">
                {seacrchResult && seacrchResult?.artists?.items?.slice(0,10).map((item:any) => <li className="col-span-1 truncate li hover:bg-neutral-700">
                        <div className="flex items-center  search-results">
                            <div className="relative">
            ...
            <section className="max-w-prose	 mx-auto grid grid-cols-2 text-white">
                ...
                <div className="col-start-1 col-end-3">
                <ul className="grid grid-cols-2 gap-4 mb-3">
                {seacrchResult && seacrchResult?.albums?.items?.slice(0,10).map((item:any) => <li className="col-span-1 truncate li hover:bg-neutral-700">
                        <div className="flex items-center  search-results">
                            <div className="relative">
                                <img className="pr-1 img" src={item.images[0]['url']} />
                                <div className="playIcon">
            ...
            <section className="max-w-prose	 mx-auto grid grid-cols-2 text-white">
                ...
                <div className="col-start-1 col-end-3">
                <ul className="grid grid-cols-2 gap-4 mb-3">
                {seacrchResult && seacrchResult?.playlists?.items?.slice(0,10).map((item:any) => <li className="col-span-1 truncate li hover:bg-neutral-700">
                        <div className="flex items-center  search-results">
                            <div className="relative">
                                <img className="pr-1 img" src={item.images[0]['url']} />
                                <div className="playIcon">
